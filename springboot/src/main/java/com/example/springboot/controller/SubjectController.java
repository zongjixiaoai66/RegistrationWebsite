...
public class SubjectController {
    ...
    public Result save(@RequestBody Subject subject) {
        if (subject.getId() == null) {
            //subject.setTime(DateUtil.now());
            //subject.setUser(TokenUtils.getCurrentUser().getNickname());
            //subject.setUserid(TokenUtils.getCurrentUser().getId());
        }
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Subject信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Subject> list = reader.readAll(Subject.class);
