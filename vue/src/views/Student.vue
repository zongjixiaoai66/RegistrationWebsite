<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload action="http://localhost:9777/user/importStudent" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe size="medium"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="username" label="学生姓名" width="140"></el-table-column>
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/user/pageByStudent", {
        params: {
