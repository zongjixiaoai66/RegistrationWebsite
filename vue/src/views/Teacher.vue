<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload action="http://localhost:9777/user/importTeacher"  :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe size="medium"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="username" label="辅导员姓名" width="140"></el-table-column>
      <el-table-column prop="nickname" label="昵称" width="120"></el-table-column>
      <el-table-column prop="email" label="邮箱"></el-table-column>
      <el-table-column prop="phone" label="电话"></el-table-column>
      <el-table-column prop="address" label="地址"></el-table-column>
      <el-table-column prop="cardnumber" label="身份证号码"></el-table-column>
      <el-table-column prop="classid" label="管理班级">
    ...
    <el-dialog title="辅导员信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item prop="classid" label="管理班级">
